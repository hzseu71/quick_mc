...
output_poisson_path = Path("./poisson/output_poisson_G2_H0e6_c.raw")
output_postlog_path = Path("./poisson/output_postlog_poisson_G2_H0e6_c.raw")
output_scatter_path = Path("./poisson/output_scatter_G2_H0e6_c.raw")
output_t_path = Path("./poisson/output_t_610_c.raw")
# === 读入图像 ===
...
imwriteRaw(norm_scatter,"./poisson/norm_scatter.raw", dtype=dtype)
# === 步骤2：计算透过光子数 ===
total_transmission = (norm_primary + norm_scatter) * photon_in
# total_transmission = (norm_primary) * photon_in
